...
//  Copyright (c) 2016 Szymon Blaszczynski. All rights reserved.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makeSlotAt(position: CGPoint, isGood: Bool) {
        func spin(isGood: Bool, slotGlow: SKSpriteNode) {
            ...
            let spin = SKAction.rotateByAngle(CGFloat(direction), duration: 10)
